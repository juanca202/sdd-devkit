...
5. **Cierre**
  ...
  - Si la US queda en **Ready**, resolver los casos de prueba según `specification.testCases.mode` (ver [`${PLUGIN_ROOT}/reference/planning.md`](../../../reference/planning.md)) y sugerir planificar tareas:
